...
import oldclients from "../../images/previous_clients.png";
...
With [Zeitios](https://www.zeitios.com/), we’re building an AI tutor that helps students learn software tools, combining curriculum generation with NLP-powered dialogue.
...
If you're interested in collaborating with DataRes Consulting, you can send us an email at [email](mailto:ucladatares.partnerships@gmail.com)!

# Previous Clients

<Image src={oldclients} alt="our previous clients" />
